        ...
        <div id="tasklist" className="flex overflow-x-auto items-center justify-start gap-10 h-[55%] flex-nowrap w-full py-5 mt-5 ">
            <div className="flex-shrink-0 h-full w-[300px] p-5 bg-red-400 rounded-xl ">
                ...
                <p className="text-sm mt-2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, amet officia modi maxime eius illo iusto quasi quae esse et sequi. Provident, quod ipsum deleniti consequatur ex fuga praesentium facilis!
                </p>
            </div>
